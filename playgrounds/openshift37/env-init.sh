...
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.7/examples/db-templates/mongodb-persistent-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.7/examples/db-templates/mysql-ephemeral-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.7/examples/db-templates/mysql-persistent-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.7/examples/db-templates/postgresql-ephemeral-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.7/examples/db-templates/postgresql-persistent-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.7/examples/db-templates/redis-ephemeral-template.json -n openshift"
ssh root@host01 "oc create -f https://github.com/openshift/origin/raw/release-3.7/examples/db-templates/redis-persistent-template.json -n openshift"
